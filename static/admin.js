window.onload = async function() { 
    loadDashboard();
    loadClassOptions(); // Populate checkboxes for spell creation
    loadSpellList();    // Populate the table of existing spells
};
...
async function submitSpell() {
    ...
    const res = await fetch("/admin/add-spell", {
...
async function submitClass() {
    ...
    const data = await res.json();
    alert(data.message);
    loadClassOptions(); // Refresh spell checkboxes
}